...
module.exports = function (app) {
  var Historicos_no_asistidos = app.db.models.Historicos_no_asistidos;
  ...
  cron.schedule("00 13 * * 2-6", function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return Turnos_no_asistidos.count({
            ...
            case 7:
              ...
              Historicos_no_asistidos.create(historicoObj).then(function (result) {
  ...
  app.route("/historicos_no_asistidos").get(function (req, res) {
    Historicos_no_asistidos.findAll().then(function (result) {
    ...
    Historicos_no_asistidos.create(req.body).then(function (result) {
      return res.json(result);
    })["catch"](function (error) {
  ...
  app.route("/historicosNoAsistidosFecha").post(function (req, res) {
